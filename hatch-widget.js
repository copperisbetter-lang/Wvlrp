...
.hatch-panel{position:fixed;right:12px;bottom:94px;z-index:2147482999;width:min(92vw,370px);max-height:min(70vh,520px);display:none;flex-direction:column;border-radius:20px;overflow:hidden;background:#06130e;border:1px solid #ffffff3b;box-shadow:0 22px 58px #000d;color:#fff;font-family:Arial,sans-serif}
...
@media(max-width:620px){.hatch-launcher{right:12px;bottom:14px;width:60px;height:60px}.hatch-panel{left:10px;right:10px;bottom:84px;width:auto;max-height:68vh}}
`;
